...
struct _PanelBaseWindow
{
  ...
  gdouble                 unmaximized_alpha;    /* added by youtian 2016.04.10 */
};
...
void         panel_base_window_set_plugin_data             (PanelBaseWindow      *window,
                                                               GtkCallback           func);
void         panel_base_window_set_plugin_background_alpha (GtkWidget            *widget,
                                                               gpointer              user_data);
G_END_DECLS

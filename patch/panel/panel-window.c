...
enum
{
  ...
  PROP_OUTPUT_NAME,
  PROP_POSITION,
  PROP_AUTO_ALPHA,       /* added by youtian 2016.04.10 */
  PROP_DISABLE_STRUTS
};
...
panel_window_class_init (PanelWindowClass *klass)
{
  ...
  g_object_class_install_property (gobject_class,
                                   PROP_AUTO_ALPHA,
                                   g_param_spec_boolean ("auto-alpha", NULL, NULL,
                                                         TRUE,
                                                         EXO_PARAM_READWRITE));
...
panel_window_init (PanelWindow *window)
{
  ...
  window->grab_x = 0;
  window->grab_y = 0;
  window->auto_alpha = TRUE;  /* added by youtian 2016.04.10 */
                           ...
                           GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    /* added by youtian 2016.04.10 */
    case PROP_AUTO_ALPHA:
      g_value_set_boolean (value, window->auto_alpha);
      break;
                           ...
                           GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_AUTO_ALPHA:
      val_bool = g_value_get_boolean (value);
      if (window->auto_alpha != val_bool)
        {
          window->auto_alpha = !!val_bool;

...
/* modified by youtian 2016.04.09 */
/*
...
panel_base_window_init (PanelBaseWindow *window)
{
  ...
  window->unmaximized_alpha = 1.00;    /* added by youtian 2016.04.10 */
                                ...
                                GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    */
    case PROP_BACKGROUND_ALPHA:
      g_value_set_uint (value, rint (window->unmaximized_alpha * 100.00));
      break;
                                ...
                                GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_BACKGROUND_ALPHA:
      ...
      window->unmaximized_alpha = g_value_get_uint (value) / 100.00;
      window->background_alpha = window->unmaximized_alpha;
      if (window->is_composited)
